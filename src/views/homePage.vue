  ...
  <body>
    <div class="banner">
      <img
        ...
        srcset="
          https://ik.imagekit.io/theperfectpixl/tr:n-20icon256/welcome-logo   256w,
          https://ik.imagekit.io/theperfectpixl/tr:n-20icon1710/welcome-logo 1710w,
          https://ik.imagekit.io/theperfectpixl/tr:n-20icon2400/welcome-logo 2400w
        "
        src="https://ik.imagekit.io/theperfectpixl/welcome-logo"
        alt="Welcome!"
      />
      <video playsinline autoplay loop muted preload="metadata" id="bannervideo">
        <source src="https://ik.imagekit.io/theperfectpixl/bumblebee-banner" type="video/mp4" />
      </video>
    </div>
    <div id="home-intro">
      <img
