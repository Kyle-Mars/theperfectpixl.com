<template>
  <body>
    <div class="banner">
      <img
        id="rid-icon"
        src="https://ik.imagekit.io/theperfectpixl/LogoRID.png"
        alt="The logo of Robots in Digsuise 2001."
      />
      ...
      <div class="body" id="gen-image">
        ...
        >
          <Transition name="search">
            <img
              v-if="image.rid && image.alt.toLowerCase().includes(search.toLowerCase())"
              class="gen-image"
